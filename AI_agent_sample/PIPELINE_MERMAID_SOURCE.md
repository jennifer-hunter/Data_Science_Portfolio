# Mermaid Source Code for Pipeline Flowcharts

This file contains the original Mermaid source code for all flowcharts.
Use this to regenerate images if needed.

To regenerate an image:
```bash
npx @mermaid-js/mermaid-cli -i input.mmd -o output.png -b white -w 1200
```
